...
% \textit{Context:} This chapter examines how software development teams build a product once  interaction designers have determined and validated the features to be built and product managers have prioritized these features into a backlog.

% \textit{Objective:} Conventional wisdom says that team disruptions (like team churn) should be avoided. Still, we have observed software development projects succeed despite high disruption. The purpose of this chapter is hence to understand how to develop software effectively, even in the face of team disruption. 
