...
In response to an increasing number of practices and methods for software development and a lack of underlying theory of software engineering, the Software Engineering Method and Theory (SEMAT) community released the \quotes{Essence: Kernel and Language} as a potential unifying theory \cite{OMGStandard}. The \quotes{universal} Essence kernel aims at providing a \quotes{common ground} for all software development endeavors \cite{JacobsonQueue}.
